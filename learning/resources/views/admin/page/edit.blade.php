                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
		                                            ...
		                                            <input type="text" name="title" id="simpleinput" value="{{$data->title}}"class="form-control">
                                        	...
                                        	<div class="col-md-6">
		                                        ...
		                                        <div class="form-group">
                                                    ...
                                                      <input type="radio" id="link"  name="type" value="link" {{$data->type == 'link'?'checked':''}}>
                                                      <label for="link">Link</label><br>
                                                      <input type="radio" id="description"  name="type" value="description" {{$data->type =='description'?'checked':''}}>
                                            ...
                                            <div class="col-md-6" id="links">
		                                        ...
		                                        <div class="form-group">
		                                            ...
		                                            <input type="text" name="link" id="simpleinput" value="{{$data->link}}" class="form-control">
		                                        </div>
                                            ...
                                            <div class="col-md-6" id="images">
		                                        ...
		                                        <div class="form-group">
                                                   ...
                                                   @if(isset($data->image))
                                                   <img src="{{asset($data->image)}}" style="width:50px" alt="">
                                            ...
                                            <div class="col-md-12" id="descriptions">
		                                        ...
		                                        <div class="form-group">
		                                            ...
		                                            <textarea name="description" id="" class="form-control summernote">{!! $data->description !!}</textarea>
		                                        </div>
