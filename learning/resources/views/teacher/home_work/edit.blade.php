                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-18">Edit Home Work</h4>
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="{{route('teacher.home_work.update', $data->id)}}" method="post"  enctype="multipart/form-data">
                                    @method('patch')
                                    @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="start_date" id="simpleinput" class="form-control" required  value="{{ $data->start_date }}">
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="due_date" id="simpleinput" class="form-control" required  value="{{ $data->due_date }}">
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="marks" id="simpleinput" class="form-control" required  value="{{ $data->marks }}">
                                                </div>
                                            ...
                                            <div class="col-xl-12">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <input type="file" name="pdf" class="dropify" data-max-file-size="1M"  data-default-file="{{ asset($data->pdf) }}"   />


                                                        <br>

                                                        <p style="font-weight: 900;">Current File: <a href="{{ asset($data->pdf) }}" target="_blank">{{ asset($data->file) }}</a></p>
