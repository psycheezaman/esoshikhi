                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="post" action="{{route('teacher.notice.store')}}" enctype="multipart/form-data">
                                        @csrf
                                            ...
                                            <div class="col-xl-12">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <input type="file" name="file" class="dropify" data-max-file-size="1M" data-default-file=""   />
